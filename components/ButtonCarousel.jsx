...
const BVideoCarousel = ({ videoURLs }) => {
  ...
  return (
    <div className="lg:hidden" data-carousel="static">
      <div className="relative">
        <div className="flex flex-row h-fit justify-center ">
          {videoURLs.map((url, index) => (
            ...
            >
              <video
                className={`rounded-lg md:h-screen ${index === currentImageIndex ? ' ' : 'hidden'
                  }`}
        ...
        <div className="absolute left-0  top-1/2 transform -translate-y-1/2 cursor-pointer md:ml-44 bg-cyan bg-opacity-25 rounded-lg" onClick={goToPreviousImage}>
          <button
            type="button"
        ...
        <div className="absolute right-0 top-1/2 transform -translate-y-1/2 cursor-pointer md:mr-44 bg-cyan bg-opacity-25 rounded-lg" onClick={goToNextImage}>
          <button
            type="button"
            className="xs:my-52 my-10"
            data-carousel-next
